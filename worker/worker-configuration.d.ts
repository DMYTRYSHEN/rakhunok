/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.corex.jsonc --env=` (hash: 76248693da563003ebab946217c7a0bb)
// Runtime types generated with workerd@1.20260826.1 2026-08-28
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SUPABASE_URL: "https://mwaeazabpvbxqfrceogr.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_BOyIBn3I0As0hP_0NutVtg_9ddFdyDk";
	SUPABASE_SERVICE_ROLE_KEY: string;
	COREX_PROCESS_WORKFLOW: Workflow<Parameters<import("./src/corex").CorexProcessWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/corex");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
