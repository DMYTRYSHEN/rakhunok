/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.terminal-isolated.jsonc worker/terminal-env.d.ts` (hash: 9d39f1d21b2d618f05db19243a013bb5)
// Runtime types generated with workerd@1.20260903.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	TERMINAL_LIMITER: RateLimit;
	ASSETS: Fetcher;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/terminal-isolated");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_BEARER_TOKEN" | "AZURE_HOST" | "MODEL_NAME">> {}
}
