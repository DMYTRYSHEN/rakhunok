...
export const canvasText = {
	uk: { journeys: 'Процеси Rahunok', trace: 'макет траси', passed: 'пройдено', active: 'активно', pending: 'очікує', processes: 'Процеси', find: 'Знайти процес', empty: 'Процесів не знайдено', canvas: 'Інтерактивна мапа процесу', catalog: 'Каталог процесів Rahunok', inspector: 'Інспектор вузла', entry: 'Точка входу', status: 'Статус', execution: 'Виконання', simulation: 'Симуляція', result: 'Результат', communication: 'Комунікація', noMutation: 'Без доступу до змін', noMutationDetail: 'Цей вузол не може викликати Cloudflare API.', fitView: 'Масштабувати (Shift+1)', addNote: 'Нотатка', inputPayload: 'Вхідний Payload (IN)', outputPayload: 'Вихідний Результат (OUT)' },
	en: { journeys: 'Rahunok processes', trace: 'mock trace', passed: 'passed', active: 'active', pending: 'pending', processes: 'Processes', find: 'Find process', empty: 'No matching process', canvas: 'Interactive process map', catalog: 'Rahunok process catalog', inspector: 'Node inspector', entry: 'Scenario entry', status: 'Status', execution: 'Execution', simulation: 'Simulation', result: 'Result', communication: 'Communication', noMutation: 'No mutation access', noMutationDetail: 'This node cannot call Cloudflare APIs.', fitView: 'Fit View (Shift+1)', addNote: 'Sticky Note', inputPayload: 'Input Payload (IN)', outputPayload: 'Output Result (OUT)' }
} as const;
