			...
			<div class="space-y-1">
				<div class="flex items-center gap-2">
					...
					<h2 class="text-base font-bold text-stone-900">
						Rahunok Auth ? Passkeys & 5-??????? pinPay ??? ???
					</h2>
				</div>
	...
	<div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
		...
		<div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm space-y-4">
			<div class="flex items-center justify-between">
				<div>
					<h3 class="text-sm font-bold text-stone-900">?????????? PIN ??? ??? ??????????????????</h3>
		...
		<div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm space-y-4">
			<div class="flex items-center justify-between">
				<div>
					<h3 class="text-sm font-bold text-stone-900">??????????? ????? ??????? (Passkeys)</h3>
					<p class="text-xs text-stone-500">???????? ?????????????? ????? Secure Enclave</p>
				</div>
				...
				<div class="flex items-center justify-between p-3.5 rounded-xl border border-stone-200 bg-stone-50 text-xs">
					<div class="flex items-center gap-3">
						...
						<div>
							...
							<div class="text-stone-500 text-[11px]">iPhone 15 Pro ? ???????? ????: ?????</div>
						</div>
					</div>
				...
				<div class="flex items-center justify-between p-3.5 rounded-xl border border-stone-200 bg-stone-50 text-xs">
					<div class="flex items-center gap-3">
						...
						<div>
							...
							<div class="text-stone-500 text-[11px]">TPM 2.0 ? ????'?????</div>
						</div>
					</div>
					<span class="text-emerald-700 font-bold">????????</span>
				</div>
	...
	<div class="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm space-y-4">
		<div class="flex items-center justify-between">
			<div>
				...
				<p class="text-xs text-stone-500">??????????? ???????????? ?????? ??? ?????????? pinPay</p>
			</div>
			<span class="text-xs text-stone-400">?????? ????'?????: {loyaltyCards.length}</span>
		</div>
			...
			{#each loyaltyCards as card}
				<div class="flex flex-col justify-between rounded-2xl border border-stone-200 bg-stone-50/50 p-4 space-y-4">
					...
					<div class="border-t border-stone-200/60 pt-3 flex items-center justify-between text-xs">
						...
						<span class="font-black text-stone-900">{card.points.toLocaleString('uk-UA')} ?.</span>
					</div>
				</div>
			{/each}
		</div>
