	...
	<header class="mb-7 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
		<div>
			...
			<p class="mt-2 max-w-3xl text-sm leading-6 text-zinc-500">
				Створіть фінансову ідентичність з адресою @handle, даними бізнесу, оплатою та перевіреними
		...
		<div class="space-y-6">
			...
			>
				...
				<p>
					...
					@handle, верифікація зовнішніх акаунтів і публічний resolver. Ця чернетка не змінює Worker або
					Supabase.
				</p>
			</div>
		</div>
