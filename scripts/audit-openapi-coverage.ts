...
const implementedOperations: ImplementedOperation[] = [
	{ method: 'GET', path: '/api/v1/health', source: 'worker/src/index.ts' },
	{ method: 'GET', path: '/api/v1/auth/config', source: 'worker/src/index.ts' },
	{
		method: 'POST',
		path: '/api/v1/auth/demo-session',
		source: 'worker/src/index.ts'
	},
	{ method: 'GET', path: '/api/v1/merchant/me', source: 'worker/src/index.ts' },
	{ method: 'PUT', path: '/api/v1/merchant/me', source: 'worker/src/index.ts' },
	{
		method: 'POST',
	...
	{ method: 'GET', path: '/api/v1/banks', source: 'worker/src/index.ts' },
	{ method: 'GET', path: '/api/v1/banks/{idOrCode}', source: 'worker/src/index.ts' },
	{ method: 'GET', path: '/api/v1/logos', source: 'worker/src/index.ts' },
	{
		method: 'POST',
	...
	{ method: 'GET', path: '/api/v1/stats/summary', source: 'worker/src/index.ts' }
];
